...
public class iClass : IDisposable
{
    ...
    {
        return System.Web.Configuration.WebConfigurationManager.ConnectionStrings["JainSeva"].ConnectionString;
    }
    ...
    public void SendSMS(string msgData, string recNumber)
    {
        try
        {
            ...
            string baseUrl = "http://164.52.205.46:6005/api/v2/SendSMS?SenderId=PSQARE&Is_Unicode=false&Is_Flash=false&Message=" + msgData + "&MobileNumbers=" + recNumber + "&ApiKey=xIW0sEqsOTTGldEfUz6qoBIOyAfvM24PvtqF4krQWrY%3D&ClientId=0be18fe5-2d9c-410e-8a00-9c3cfd25d475";
